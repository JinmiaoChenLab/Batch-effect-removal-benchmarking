  ...
  base_name <- 'results_dataset7_mouse_retina/'  # change to your dataset name
  dir.create(base_name, showWarnings = FALSE)
  

  data_dir <- '/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/dataset/dataset7_Mouse_retina/final/'
