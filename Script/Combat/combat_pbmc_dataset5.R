...
read_dir = "/home/hoa/hoatran/demo_normalization/dataset/dataset5_human_pbmc/final/"
...
setwd(this.dir)
data_dir <- '/home/hoa/hoatran/demo_normalization/dataset/dataset5_human_pbmc/final/'
base_name <- 'combat_dataset5/'
...
opt1 <- './combat_dataset5/parametric/'
# opt2 <- './combat_dataset5/non-parametric/'
...
combat_srt <- CreateSeuratObject(raw.data = combat_output, project = "dataset5_combat")
dim(combat_srt@raw.data)  # 17208  15476
