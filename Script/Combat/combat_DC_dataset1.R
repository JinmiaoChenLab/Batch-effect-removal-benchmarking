...
opt1 <- './combat_dataset1/parametric/'
# opt2 <- './combat_dataset1/non-parametric/'
...
combat_srt <- CreateSeuratObject(raw.data = combat_output, project = "dataset1_combat")
dim(combat_srt@raw.data)  # 15074 565
