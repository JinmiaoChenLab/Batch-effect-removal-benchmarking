...
read_dir = "/home/hoa/hoatran/demo_normalization/dataset/dataset7_Mouse_retina/final/"
...
setwd(this.dir)
data_dir <- '/home/hoa/hoatran/demo_normalization/dataset/dataset7_Mouse_retina/final/'
base_name <- 'combat_dataset7/'
...
opt1 <- './combat_dataset7/parametric/'
# opt2 <- './combat_dataset7/non-parametric/'
...
combat_srt <- CreateSeuratObject(raw.data = combat_output, project = "dataset7_combat")
dim(combat_srt@raw.data)  # 12333 62732
