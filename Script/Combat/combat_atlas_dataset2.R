...
opt1 <- './combat_dataset2/parametric/'
# opt2 <- './combat_dataset2/non-parametric/'
...
combat_srt <- CreateSeuratObject(raw.data = combat_output, project = "dataset2_combat")
dim(combat_srt@raw.data)  # 15006 6954
