...
opt1 <- './combat_dataset6/parametric/'
# opt2 <- './combat_dataset6/non-parametric/'
...
combat_srt <- CreateSeuratObject(raw.data = combat_output, project = "dataset6_combat")
dim(combat_srt@raw.data)  # 16409  9531
