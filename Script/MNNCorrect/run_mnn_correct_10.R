...
npcs = 20
visualize = T
outfile_prefix = "Dataset10"
save_obj = F

src_dir = "./"
working_dir = "../../Output/"
#working_dir = "/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/koksiong/v2.1/02_seurat2/10/"
read_dir = "/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/dataset/dataset10_hematoMNN_Hoa/final/"
#read_dir = "../../Data/"
