...
seurat2_df <- read.csv(paste(input_path,"dataset1_seurat2_pca_tsne.csv",sep="/"), head=T, row.names = 1, check.names = FALSE)

harmony_df <- read.csv(paste(input_path,"dataset1_harmony_pca_tsne.csv",sep="/"), head=T, row.names = 1, check.names = FALSE)

scanorama_df <- read.csv(paste(input_path,"dataset1_scanorama_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

# bbknn_df <- read.csv("bbknn_tsne.csv", row.names = 1, check.names = FALSE)

scgen_df <- read.csv(paste(input_path,"dataset1_scGen_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

resnet_df <- read.csv(paste(input_path,"dataset1_resnet_s1_t2_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

raw_df <- read.csv(paste(raw_path,"rawdata_tsne_renamed.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

fastMNN_df <- read.csv(paste(input_path,"dataset1_fastMNN_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

seurat3_df <- read.csv(paste(input_path,"dataset1_seurat3_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

correctMNN_df <- read.csv(paste(input_path,"dataset1_classicMNN_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

combat_df <- read.csv(paste(input_path,"dataset1_combat_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

limma_df <- read.csv(paste(input_path,"dataset1_limma_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

liger_df <- read.csv(paste(input_path,"dataset1_liger_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

scmerge_df <- read.csv(paste(input_path,"dataset1_scmerge_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)

zinbwave_df <- read.csv(paste(input_path,"dataset1_zinbwave_pca_tsne.csv", sep="/"),head=T, row.names = 1, check.names = FALSE)
