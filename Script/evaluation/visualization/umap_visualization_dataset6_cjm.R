...
input_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/xiaomeng/generate_PCA_tSNE_UMAP/dataset6/"
raw_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/manuscript_results/dataset6_cell_line/visualization/raw/"
bbknn_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/manuscript_results/dataset6_cell_line/visualization/bbknn/"
...
scgen_df <- read.csv(paste0(input_path,dataset,"_scgene_umap.csv"),head=T, row.names = 1, check.names = FALSE)
...
raw_df <- read.csv(paste0(raw_path,"rawdata_umap_renamed.csv"),head=T, row.names = 1, check.names = FALSE)
...
plot_df$celltype[plot_df$celltype=="293t"] = "293T"
plot_df$celltype[plot_df$celltype=="jurkat"] = "Jurkat"
###
