...
input_path = "T:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/xiaomeng/generate_PCA_tSNE_UMAP/dataset7/"
raw_path = "T:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/manuscript_results/dataset7_Mouse_retina/visualization/raw/"
...
#scmerge_df <- read.csv(paste0(input_path,dataset,"_liger_tsne.csv"),head=T, row.names = 1, check.names = FALSE)
