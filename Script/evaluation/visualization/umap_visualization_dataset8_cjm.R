...
input_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/xiaomeng/generate_PCA_tSNE_UMAP/dataset8/"
raw_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/xiaomeng/generate_PCA_tSNE_UMAP/dataset8/"
bbknn_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/xiaomeng/generate_PCA_tSNE_UMAP/dataset8/"
...
raw_df <- read.csv(paste0(raw_path,dataset,"_raw_umap.csv"),head=T, row.names = 1, check.names = FALSE)
...
bbknn_df <- read.csv(paste0(bbknn_path,dataset,"_bbknn_umap.csv"),head=T, row.names = 1, check.names = FALSE)
