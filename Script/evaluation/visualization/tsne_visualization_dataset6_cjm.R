...
scgen_df <- read.csv(paste0(input_path,dataset,"_scgene_tsne.csv"),head=T, row.names = 1, check.names = FALSE)
...
raw_df <- read.csv(paste0(raw_path,"rawdata_tsne_renamed.csv"),head=T, row.names = 1, check.names = FALSE)
