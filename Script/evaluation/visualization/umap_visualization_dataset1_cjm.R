...
input_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/xiaomeng/generate_PCA_tSNE_UMAP/dataset1/"
raw_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/manuscript_results/dataset1_uc3/visualization/"
bbknn_path = "X:/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/manuscript_results/dataset1_uc3/visualization/"
...
seurat2_df <- read.csv(paste0(input_path,dataset,"_seurat2_pca_umap.csv"), head=T, row.names = 1, check.names = FALSE)
seurat2_df=correct_name(seurat2_df)

harmony_df <- read.csv(paste0(input_path,dataset,"_harmony_pca_umap.csv"), head=T, row.names = 1, check.names = FALSE)
harmony_df=correct_name(harmony_df)
  
scanorama_df <- read.csv(paste0(input_path,dataset,"_scanorama_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
scanorama_df=correct_name(scanorama_df)
# bbknn_df <- read.csv("bbknn_umap.csv", row.names = 1, check.names = FALSE)

scgen_df <- read.csv(paste0(input_path,dataset,"_scgen_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
scgen_df=correct_name(scgen_df)

resnet_df <- read.csv(paste0(input_path,dataset,"_resnet_s2_t1_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
...
fastMNN_df <- read.csv(paste0(input_path,dataset,"_fastMNN_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
fastMNN_df=correct_name(fastMNN_df)

seurat3_df <- read.csv(paste0(input_path,dataset,"_seurat3_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
seurat3_df=correct_name(seurat3_df)

correctMNN_df <- read.csv(paste0(input_path,dataset,"_classicMNN_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
correctMNN_df=correct_name(correctMNN_df)

combat_df <- read.csv(paste0(input_path,dataset,"_combat_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
combat_df=correct_name(combat_df)

limma_df <- read.csv(paste0(input_path,dataset,"_limma_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
limma_df=correct_name(limma_df)

liger_df <- read.csv(paste0(input_path,dataset,"_liger_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
liger_df=correct_name(liger_df)

scmerge_df <- read.csv(paste0(input_path,dataset,"_scmerge_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
scmerge_df=correct_name(scmerge_df)

zinbwave_df <- read.csv(paste0(input_path,dataset,"_zinbwave_pca_umap.csv"),head=T, row.names = 1, check.names = FALSE)
