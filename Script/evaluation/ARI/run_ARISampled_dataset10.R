...
this_dir<-"./generate_PCA_tSNE_UMAP/dataset10/"

# send output to out_dir
out_dir<-"./ARI_dataset10/"
...
wholedf<-conclude_ARISampled(dir_this, "Dataset_10") 

save.image(paste0("Dataset10", "_complete.RData"))
