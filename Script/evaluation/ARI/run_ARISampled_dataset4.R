...
this_dir<-"./generate_PCA_tSNE_UMAP/dataset4/"

# send output to out_dir
out_dir<-"./ARI_dataset4/"
...
wholedf<-conclude_ARISampled(dir_this, "Dataset_4") 

save.image(paste0("Dataset4", "_complete.RData"))
