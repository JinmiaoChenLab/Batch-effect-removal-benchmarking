...
setwd(this_dir)
data_dir = '/acrc/jinmiao/CJM_lab/hoatran/demo_normalization/xiaomeng/generate_PCA_tSNE_UMAP/dataset4/'
...
#### iteration 
size = length(meta_ls$cells_extract)  # 1640
...
mclapply(1:length(kns), function(i){
  kn = kns[i]
  print(paste0('____________k0: ', kn))
