...
this_dir<-"./generate_PCA_tSNE_UMAP/dataset1/"  

# send output to out_dir
out_dir<-"./ARI_dataset1/"
...
wholedf<-conclude_ARISampled(dir_this, "Dataset_1") 

save.image(paste0("Dataset1", "_complete.RData"))
