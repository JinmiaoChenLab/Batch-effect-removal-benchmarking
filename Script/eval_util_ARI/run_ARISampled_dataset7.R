...
this_dir<-"./generate_PCA_tSNE_UMAP/dataset7/"

# send output to out_dir
out_dir<-"./ARI_dataset7/"
...
wholedf<-conclude_ARISampled(dir_this, "Dataset_7") 

save.image(paste0("Dataset7", "_complete.RData"))
